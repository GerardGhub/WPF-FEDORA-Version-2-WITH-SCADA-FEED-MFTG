...
namespace WFFDR
{
    public partial class frmReprintFinishedGoods : Form
    {
        ...
        string Rpt_Path = "";
        public frmReprintFinishedGoods()
        {
            InitializeComponent();
        }

        private void frmReprintFinishedGoods_Load(object sender, EventArgs e)
        {
        ...
        void load_search()
        {
            ...
            dset_emp1 = objStorProc.sp_getMajorTables("searchrepackbagging");
        ...
        void doSearch()
        {
            //if (txtprod_id.Text.Trim() == string.Empty)
            //{
        ...
        private void metroButton4_Click(object sender, EventArgs e)
        {
            if (MetroFramework.MetroMessageBox.Show(this, "Print Finished Goods Bagging Barcoding Entry? ", "Information", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
                ...
                if (mode == "company")
                {
                    myglobal.REPORT_NAME = "IDFGReprintBagsreprint";
        ...
        private void btnrefresh_Click(object sender, EventArgs e)
        {
            ...
            frmReprintFinishedGoods_Load(sender,e);
        }
