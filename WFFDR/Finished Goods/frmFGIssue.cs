    ...
    public partial class frmFGIssue : Form
    {
        ...
        private void tscancelbtn_Click(object sender, EventArgs e)
        {
            ...
            if (MetroFramework.MetroMessageBox.Show(this, "Are you sure you want to cancel this Transaction ? ", "Information", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
                ...
                {
                    dSet.Clear();
                    dSet = objStorProc.rdf_sp_move_order(0, ordermain.Text.Trim(), "", "", "", "", "", feedcodemain.Text.Trim(), "", bagbulkmain.Text.Trim(), fgdate.Text.Trim(), "", "", "", "", "", productionmain.Text.Trim().ToString(), "", "", 0, "", "", myfgidbulk.Text.Trim().ToString(), "cancelmoveorderbulkissue");
        ...
        {
            string mcolumns = "test,order_no,feed_code,feed_type,sack_bin,uom,qty,Pdate,Fdate,production,my_fgid";     /* ,InitialMemoReleased,ResolutionMemoReleased*/
            pointer_module.populateModule(dsetHeader, Dgvmain, mcolumns, "Callissue");
        ...
        private void Queryconfirmorderfinal()
        {
            ...
            dSet.Clear();
            dSet = objStorProc.rdf_sp_move_order(0, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", dateonly.Text.Trim(), 0, "", "", "", "confirmorderfinalissue");
        ...
        private void Queryupdaterdfmoveordertable()
        {
            ...
            dSet.Clear();
            dSet = objStorProc.rdf_sp_move_order(0, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 0, "", "", "", "updaterdfmoveordertableissue");
        ...
        {
            dSet.Clear();
            dSet = objStorProc.rdf_sp_move_order(0, fgid.Text.Trim(), "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 0, "", "", "", "showaddlineissue");
        ...
        {
            dSet.Clear();
            dSet = objStorProc.rdf_sp_move_order(0, fgidbulk.Text.Trim(), "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 0, "", "", "", "showaddline");
        ...
        {
            dSet.Clear();
            dSet = objStorProc.rdf_sp_move_order(0, "", "", "", "", "", "", feedcodemain.Text.Trim(), "", bagbulkmain.Text.Trim(), fgdate.Text.Trim(), "", "", "", "", "", productionmain.Text.Trim(), "", "", 0, "", "", "", "cancelissue");
        }
        ...
        {
            dSet.Clear();
            dSet = objStorProc.rdf_sp_move_order(0, "", "", "", "", "", "", feedcodemain.Text.Trim(), "", bagbulkmain.Text.Trim(), fgdate.Text.Trim(), quantity.Text.Trim(), "", "", "", "", productionmain.Text.Trim().ToString(), "", "", 0, lblsasa.Text.Trim(), dateonly.Text.Trim(), "", "cancelrdfmoveordertableissue");
        ...
        {
            dSet.Clear();
            dSet = objStorProc.rdf_sp_new_finish_goods(0, ordermain.Text.Trim(), feedcodemain.Text.Trim(), feedtypemain.Text.Trim(), quantity.Text.Trim(), txtbatch.Text.Trim(),
