...
namespace WFFDR
{
    public partial class frmMiscellaneousOutReport : Form
    {
        ...
        private void frmMiscellaneousOutReport_Load(object sender, EventArgs e)
        {
        ...
        public void load_Schedules()
        {
            ...
            pointer_module.populateModule(dsetHeader, dgvApproved, mcolumns, "transaction_materials_out");
        ...
        public void load_search()
        {
            ...
            { dset_emp = objStorProc.sp_getMajorTables("transaction_materials_out"); }
        ...
        private void bntPrint_Click(object sender, EventArgs e)
        {
            ...
            myglobal.REPORT_NAME = "MaterialsOut";
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
           ...
           // myglobal.REPORT_NAME = "ProductionPlanning";
            myglobal.REPORT_NAME = "StockoutMaterials";
