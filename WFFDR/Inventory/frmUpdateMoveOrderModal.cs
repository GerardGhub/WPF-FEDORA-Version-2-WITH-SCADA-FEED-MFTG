...
namespace WFFDR
{
    public partial class frmUpdateMoveOrderModal : Form
    {
        frmMoveOrder ths;
        public frmUpdateMoveOrderModal(frmMoveOrder frm, string prodid, string order_no, string encodedby, string actualqty, string input, string inventory, string available, string subtract, string moveorder, string actual, string addition, string totalmoveorder, string key, string date)
        {
            InitializeComponent();
            ths = frm;
        ...
        private void frmUpdateMoveOrderModal_Load(object sender, EventArgs e)
        {
        ...
        void UpdateData()
        {
            ...
            string sqlquery = "UPDATE [dbo].[rdf_move_order]  SET qty='" + txtinput.Text + "' where move_id='" + lblid.Text + "'";
