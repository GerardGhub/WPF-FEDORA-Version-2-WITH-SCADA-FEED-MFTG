...
namespace WFFDR
{
    public partial class RawMatsRepackingTracking : Form
    {
        ...
        public RawMatsRepackingTracking()
        {
            InitializeComponent();
        }

        private void RawMatsRepackingTracking_Load(object sender, EventArgs e)
        {
        ...
        private void dgv_table_2nd_sup_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
        ...
        private void bunifuUndo_Click(object sender, EventArgs e)
        {
            if(mode =="active")
            {
                ...
                toolStripLabel1.Text = "Inactive Micro Raw Materials Repacking Entry";
                lblrepackcount.Visible = false;
                lblrepackcount2.Visible = true;
                mode = "inactive";
                bunifuUndo.ButtonText = "HIDE REPACKING (DESCRIPTION)";
            }
            else
            {
                ...
                mode = "active";
                toolStripLabel1.Text = "Micro Raw Materials Repacking Entry";
