...
namespace WFFDR
{
    ...
    public partial class fmApproveQAMacro : Form
    {
        ...
        public fmApproveQAMacro()
        {
            InitializeComponent();
        }

        private void fmApproveQAMacro_Load(object sender, EventArgs e)
        {
        ...
        public void load_posummary_report()
        {
            ...
            pointer_module.populateModule(dsetHeader, dgv_po_approve, mcolumns, "qa_po_receiving2");
        ...
        private void btngreaterthan_Click(object sender, EventArgs e)
        {
            ...
            myglobal.REPORT_NAME = "DailyMacroReceiving";
        ...
        void load_search()
        {
            ...
            dset_emp = objStorProc.sp_getMajorTables("qa_po_receiving2");
