...
{
    public partial class FrmMiscellaneousIssueSlip : Form
    {
        ...
        public FrmMiscellaneousIssueSlip()
        {
            InitializeComponent();
        }

        private void FrmMiscellaneousIssueSlip_Load(object sender, EventArgs e)
        {
        ...
        public void load_Schedules()
        {
            ...
            pointer_module.populateModule(dsetHeader, dgvApproved, mcolumns, "transaction_miscellaneous_issueshow");
        ...
        public void load_search()
        {
            ...
            { dset_emp = objStorProc.sp_getMajorTables("transaction_miscellaneous_issueshow"); }
